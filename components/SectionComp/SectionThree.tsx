...
export default function SectionThree() {
  return (
    <section className="main-container flex flex-col justify-center items-center mt-[550px]">
      ...
      <div className="flex mt-10 justify-between">
        <div className="aspect-square w-[400px] rounded-md overflow-clip">
          <Image src={fourimg} alt="section three image" />
        </div>
        <div className="flex flex-col gap-6 w-[50%] translate-y-[20px]">
          <div className="">
